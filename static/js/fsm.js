...
export class UnifiedFSM {
  ...
  static TRANSITIONS = Object.freeze({
    novel_select: Object.freeze({
      ...
      confirming: ['novel_select.ready', 'novel_select.idle', 'novel_select.selecting'],
    ...
    narrative: Object.freeze({
      awaiting_start: ['narrative.generating'],
      generating: ['narrative.choosing', 'narrative.playing', 'novel_select.ready'],
      choosing: ['narrative.generating'],
      playing: ['narrative.generating'],

...
export class UnifiedFSM {
  ...
  static TRANSITIONS = Object.freeze({
    novel_select: Object.freeze({
      idle: ['novel_select.scanning', 'novel_select.list_received', 'novel_select.confirming', 'novel_select.selecting', 'narrative.playing'],
      scanning: ['novel_select.list_received', 'novel_select.error', 'novel_select.idle'],
      list_received: ['novel_select.confirming', 'novel_select.idle', 'novel_select.selecting', 'novel_select.scanning', 'narrative.playing'],
      selecting: ['novel_select.generating', 'novel_select.ready', 'novel_select.list_received', 'novel_select.idle', 'novel_select.confirming', 'novel_select.scanning', 'narrative.playing'],
      confirming: ['novel_select.idle', 'novel_select.list_received', 'novel_select.confirming', 'novel_select.selecting', 'novel_select.generating', 'novel_select.ready', 'novel_select.scanning', 'narrative.awaiting_start', 'narrative.playing'],
      generating: ['novel_select.ready', 'novel_select.error', 'novel_select.idle', 'narrative.playing'],
      ready: ['novel_select.idle', 'narrative.awaiting_start', 'novel_select.confirming', 'novel_select.selecting', 'novel_select.scanning', 'narrative.playing'],
      error: ['novel_select.idle', 'novel_select.scanning', 'narrative.playing'],
    }),
    narrative: Object.freeze({
      awaiting_start: ['narrative.generating', 'novel_select.scanning', 'narrative.playing'],
      generating: ['narrative.choosing', 'narrative.playing'],
      choosing: ['narrative.generating', 'narrative.awaiting_start'],
      playing: ['narrative.generating', 'narrative.awaiting_start', 'novel_select.scanning'],
